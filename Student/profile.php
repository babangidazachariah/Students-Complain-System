                    ...
                    <fieldset>
                        <table width='100%'>
							<?php
								...
								$query = mysqli_query($db,"SELECT * FROM tblStudents WHERE studentEmail ='$email' OR studentMatricNumber ='$email'") or die(mysqli_error($db));
							   ...
							   if(mysqli_num_rows($query) > 0){
									while($row = mysqli_fetch_assoc($query)){
										...
										<tr>
											<td width='40%' align='right'>
												<font color='black' name='Arial' size='10'><b>Matric Number:</b></font>
											</td>
											<td width='60%'>
												<font color='black' name='Arial' size='10'><b>".
												$row['studentMatricNumber']."</b></font>
											</td>
										</tr>
										<tr>
											<td width='40%' align='right'>
