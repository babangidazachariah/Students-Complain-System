                    ...
                    <?php 
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if(empty($email) || empty($pass)){
							   ...
							   $query = mysqli_query($db,"SELECT * FROM tblStudents WHERE (studentMatricNumber ='$email' OR studentEmail ='$email') AND studentPassword ='$pass'") or die(mysqli_error($db));
                     ...
                     ?>
                <legend><i class="fa fa-user-plus"></i> Student Login</legend>
                <div class="col-sm-12">
