                    ...
                    <?php 
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if(empty($email) || empty($pass)){
							   ...
							   $query = mysqli_query($db,"SELECT * FROM tblLecturer WHERE lecturerEmail ='$email' AND lecturerPassword ='$pass'") or die(mysqli_error($db));
							   
							   if(mysqli_num_rows($query) > 0){
									while($row = mysqli_fetch_assoc($query)){
										$_SESSION['lecturer'] = $row['lecturerEmail'];
										$_SESSION['lecSch'] = $row['lecturerSchool'];
									}
                     ...
                     ?>
                <legend><i class="fa fa-user-plus"></i> LECTURER LOGIN</legend>
                <div class="col-sm-12">
