							...
							<?php
								 if(!empty($search)){
									print($search);
										...
										$query = mysqli_query($db,"SELECT tblStudents.*, tblInstitution.institutionName FROM tblStudents, tblInstitution WHERE tblStudents.studentSchool = tblInstitution.institutionID") or die(mysqli_error($db));
